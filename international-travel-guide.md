...
Keep in mind, if you're traveling more than 10 hours in the air (not including layovers), Atomos Space will cover the cost of a business class ticket, up to $5000, twice a year.
...
* 1Password
  ...
  * Turn on Travel Mode. Go to https://Atomos Space.1password.com/profile and click Enable Travel Mode.
...
* Email apps
  * If you use an email app rather than Gmail in your browser, remove the @Atomos Space.com account.
...
* Common questions:
  ...
  * Here to do work? Nope! Here on business, meeting with Atomos Space.
...
* Atomos Space app: Reinstall on your phone, tablet, and laptop.
...
* Email apps: Add your @Atomos Space.com account again.
